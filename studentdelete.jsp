...
<html>
<head>
	<title>Student Deactivation</title>
</head>
...
<tr>
	...
	<td width="750">
<h4><font color="#843f8b"><div align=center>Deactivate Student</div></font></h4>

<form action="/chennaicopp/studentdelete2.jsp" name="valid" method="post" onsubmit="return Validation()">
    <table align="center">
<tr>
                  <td>Enter Reg NO  : </td>
